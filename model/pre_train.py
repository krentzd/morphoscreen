...
def train(model,
    ...
    for epoch in range(start_epoch, epochs):
        ...
        plt.legend()
        plt.title('Loss')
        plt.savefig(os.path.join(save_dir, f'pre_train_loss_curves_from_{start_epoch}.png'))
        plt.close()
        ...
        plt.legend()
        plt.title('Accuracy')
        plt.savefig(os.path.join(save_dir, f'pre_train_accuracy_curves_from_{start_epoch}.png'))
        plt.close()
